...
--
-- Table structure for table `global_domain_tags`
--

DROP TABLE IF EXISTS `global_domain_tags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `global_domain_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `global_domain_id` int(11) DEFAULT NULL,
  `global_tag_id` int(11) DEFAULT NULL,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `global_domain_tags`
--

LOCK TABLES `global_domain_tags` WRITE;
/*!40000 ALTER TABLE `global_domain_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `global_domain_tags` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (44,'root','9b2b0416194bfdd0db089b9c09fad3163eae5383','5772d8bc-b5c4-4962-8fe9-6fc703662c24','root','','','','',1,0,4,8,4,NULL,1,8,'2012-12-10 13:14:13','2016-06-28 22:06:20'),(182,'admin_college','b0451947e4b0ee5b5ee981afe174e6630d72ff58','521dc362-81a4-4a34-8a0b-052f03662c24','','','','','',1,1,4,9,4,44,2,5,'2013-08-28 11:31:14','2017-01-01 20:42:14'),(190,'admin_freddy','7fbcbcb1b08834dc4b2579d30b9fe258b71a71a9','5819c235-f444-4942-a04d-03af03662c24','','','','','',1,1,4,9,4,44,6,7,'2013-10-25 11:22:19','2017-01-01 20:42:15'),(191,'Delete ME','dd4a1042d2007dfb8994efe8ad254bf0ddff2da0','5f1d974b-8e9d-47f2-8ae1-ddb36000e9f5','','','','','',1,0,4,9,4,182,3,4,'2017-01-01 19:53:43','2017-01-01 20:42:15');
...
-- Dump completed on 2017-01-02  8:43:16
