    ...
    return function (co) {    //co is short for config object
        ...
        var eventBindings = function(){
            ...
            var menu_items_plain = [
                {id: 'mnuHelp', value: i18n('sHelp'),  icon:'question-circle'},
                {id: 'mnuAbout', value: i18n('sAbout'), icon:'info'}
            ]
            ...
            webix.ui({
                ...
                body    : {
	                ...
	                template    : "<span class='webix_icon fa-#icon#'></span><span class='#css#'> #value#</span>",
	                view:"menu",
                    id:"my_menu",
                    subMenuPos:"right",
                    layout:"y",
