Ext.define('Rd.controller.cFinPaymentPlans', {
    ...
    views:  [
        ...
        'finPaymentPlans.winFinPaymentPlanAdd', 	'finPaymentPlans.winFinPaymentPlanEdit'
    ],
    stores: ['sFinPaymentPlans', 'sAccessProvidersTree'],
    models: ['mFinPaymentPlan',  'mAccessProviderTree' ],
    selectedRecord: null,
    config: {
