Ext.define('Rd.controller.cFinPremiumSmsTransactions', {
    extend: 'Ext.app.Controller',
    actionIndex: function(){

        var me = this;
        var desktop = this.application.getController('cDesktop');
        var win = desktop.getWindow('finPremiumSmsTransactionsWin');
        if(!win){
            win = desktop.createWindow({
                id: 'finPremiumSmsTransactionsWin',
                //title: i18n('sProfile_component_manager'),
                btnText: 'Premium SMS transactions',
                width:800,
                height:400,
                ...
                layout: 'border',
                stateful: true,
                stateId: 'finPremiumSmsTransactionsWin',
                items: [
                    {
                        region: 'north',
                        xtype:  'pnlBanner',
                        //heading: i18n('sProfile_component_manager'),
                        heading: 'Premium SMS transaction manager',
                    ...
                    },
                    {
                        ...
                        layout  : 'fit',
                        border  : false,
                        xtype   : 'gridPremiumSmsTransactions'
                    }
                ]
            });
        }
    ...
    views:  [
        'components.pnlBanner',             'finPremiumSmsTransactions.gridPremiumSmsTransactions',
        'components.winCsvColumnSelect',    'components.winNote', 'components.winNoteAdd',
        'finPremiumSmsTransactions.winPremiumSmsEmailVoucherDetail'
    ],
    stores: ['sFinPremiumSmsTransactions', 'sAccessProvidersTree'],
    models: ['mFinPremiumSmsTransaction',  'mAccessProviderTree' ],
    selectedRecord: null,
    config: {
    ...
    refs: [
        {  ref: 'grid',  selector: 'gridPremiumSmsTransactions'}       
    ],
    init: function() {
        var me = this;
        if (me.inited) {
        ...
        me.inited = true;
        me.control({
            '#finPremiumSmsTransactionsWin'    : {
                beforeshow  : me.winClose,
                destroy     : me.winClose
            },
            'gridPremiumSmsTransactions #reload': {
                click:      me.reload
            },
