Ext.define('Rd.controller.cProfileComponents', {
            ...
            win = desktop.createWindow({
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        margins : '0 0 0 0',
                        border  : true,
                        items   : { 'title' : i18n('sComponents'), xtype: 'gridProfileComponents'}
                    }
                ]
            });
        }
    ...
    init: function() {
        ...
        me.getStore('sProfileComponents').addListener('load',me.onStoreProfileComponentsLoaded, me);
        me.control({
            ...
            '#winCsvColumnSelectProfileComponents':{
                toFront:       me.maskHide
            },
            ...
            'winNote[noteForGrid=profile_components]':{
                toFront:       me.maskHide
            },
                ...
                if(val== 'yes'){
                    ...
                    me.getGrid().getStore().sync({
                        success: function(batch,options){
                            ...
                            me.onStoreProfileComponentsLoaded();   //Update the count   
                        },
