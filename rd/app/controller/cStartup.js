...
Ext.define('Rd.controller.cStartup', {
    ...
    actionIndex: function(){
        ...
        Ext.Ajax.request({
            url: me.config.urlLocalizedStrings,
            params: {
                language: language
            },
            method: 'GET',
            success: function(response){
                ...
                if(jsonData.success){
                    ...
                    Ext.Ajax.extraParams = {'sel_language': me.application.getSelLanguage()};
            ...
            Ext.Ajax.request({
                ...
                success: function(response){
                    ...
                    if(jsonData.success){ //Token is ok, let us continiue
                        ...
                        Ext.Ajax.extraParams = {'token': token,'sel_language': me.application.getSelLanguage()};
