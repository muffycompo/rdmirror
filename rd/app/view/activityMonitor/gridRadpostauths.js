Ext.define('Rd.view.activityMonitor.gridRadpostauths' ,{
    ...
    initComponent: function(){
        ...
        me.columns  = [
            ...
            { text: i18n('sNasname'),       dataIndex: 'nasname',       tdCls: 'gridTree', flex: 1,filter: {type: 'string'}},
            { text: i18n('sDate'),          dataIndex: 'authdate',      tdCls: 'gridTree', flex: 1,filter: {type: 'date',dateFormat: 'Y-m-d'}}
        ];
