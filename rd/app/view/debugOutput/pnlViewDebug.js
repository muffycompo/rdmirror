Ext.define('Rd.view.debugOutput.pnlViewDebug', {
    ...
    tbar: [
        { xtype: 'buttongroup', title: i18n('sAction'), items : [ 
            ...
            { xtype: 'button',  iconCls: 'b-start',  glyph: Rd.config.icnStart,   scale: 'large', itemId: 'start',    tooltip:    i18n('sStart_debug'),
                toggleGroup     : 'start_stop',
                enableToggle    : true,
                pressed         : true

            },
            { xtype: 'button',  iconCls: 'b-stop', glyph: Rd.config.icnStop,     scale: 'large', itemId: 'stop',     tooltip:    i18n('sStop_debug'),
                toggleGroup     : 'start_stop',
                enableToggle    : true,
                pressed         : false
            },
            { xtype: 'button',  iconCls: 'b-time_add', glyph: Rd.config.icnAdd, scale: 'large', itemId: 'time',     tooltip:    i18n('sAdd_debug_time')}
