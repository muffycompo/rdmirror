Ext.define('Rd.view.meshes.gridMeshViewNodeDetails' ,{
    ...
    initComponent: function(){
        ...
        me.columns  = [
            ...
            { text: i18n('sDescription'),       dataIndex: 'description',    tdCls: 'gridTree', flex: 1,stateId: 'StateGMVND3'},
            { text: i18n('sMAC_Address'),       dataIndex: 'mac',            tdCls: 'gridTree', flex: 1,stateId: 'StateGMVND4'},
            { text: i18n('sHardware'),          dataIndex: 'hardware',       tdCls: 'gridTree', flex: 1,stateId: 'StateGMVND5'},
            { text: i18n('sPower'),             dataIndex: 'power',          tdCls: 'gridTree', flex: 1,stateId: 'StateGMVND6'},
            ...
            { 
                ...
                dataIndex: 'static_entries',stateId: 'StateGMVND8'
            }, 
            { 
                ...
                dataIndex: 'static_exits',stateId: 'StateGMVND9'
            }  
        ];
