Ext.define('Rd.view.templates.winTemplateAddWizard', {
    extend:     'Ext.window.Window',
    alias :     'widget.winTemplateAddWizard',
    closable:   true,
    draggable:  false,
    resizable:  false,
    title:      i18n('sNew_profile_template'),
    width:      400,
    height:     400,
    plain:      true,
    border:     false,
    ...
    mkScrnApTree: function(){
        ...
        var pnlTree = Ext.create('Ext.tree.Panel',{
            ...
            border: false,
            tbar: [
                { xtype: 'tbtext', text: i18n('sSelect_the_template_owner'), cls: 'lblWizard' }
            ],
            columns: [
                {
    ...
    //_______ Data for template  _______
    mkScrnData: function(){
