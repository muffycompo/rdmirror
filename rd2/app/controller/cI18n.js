Ext.define('Rd.controller.cI18n', {
        ...
        if(me.getPhpGrid().getSelectionModel().getCount() == 0){
            ...
            Ext.Msg.confirm(i18n('sConfirm'), i18n('sAre_you_sure_you_want_to_do_that_qm'), function(val){
                if(val== 'yes'){
                    ...
                    var url = me.urlPhpDel+"?language="+me.selPhpLanguage;
    ...
    phpEditSubmit: function(button){
        ...
        form.submit({
            clientValidation: true,
            url: me.urlPhpEditMsgid+"?language="+me.selPhpLanguage,
            success: function(form, action) {
                win.close();
                me.getPhpGrid().getStore().load();
                Ext.ux.Toaster.msg(
    ...
    phpCommentSubmit: function(button){
        ...
        form.submit({
            clientValidation: true,
            url: me.urlPhpComment+"?language="+me.selPhpLanguage,
            success: function(form, action) {
                win.close();
                me.getPhpGrid().getStore().load();
                Ext.ux.Toaster.msg(
    ...
    phpMetaSubmit: function(button){
        ...
        form.submit({
            clientValidation: true,
            url: me.urlPhpMeta+"?language="+me.selPhpLanguage,
            success: function(form, action) {
                win.close();
                me.getPhpGrid().getStore().load();
                Ext.ux.Toaster.msg(
