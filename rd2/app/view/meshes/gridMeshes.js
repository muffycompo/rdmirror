Ext.define('Rd.view.meshes.gridMeshes' ,{
    ...
    initComponent: function(){
        ...
        me.columns  = [
            ...
            { text: 'SSID',             dataIndex: 'ssid',          tdCls: 'gridTree', flex: 1,filter: {type: 'string'},hidden: true,stateId: 'StateGridMeshes4'},
            { text: 'BSSID',            dataIndex: 'bssid',         tdCls: 'gridTree', flex: 1,filter: {type: 'string'},hidden: true,stateId: 'StateGridMeshes5'},
            { text: 'Node count',       dataIndex: 'node_count',    tdCls: 'gridTree', flex: 1,stateId: 'StateGridMeshes6'},
            { text: 'Nodes up',         dataIndex: 'nodes_up',      tdCls: 'gridTree', flex: 1,stateId: 'StateGridMeshes7'},
            { text: 'Nodes down',       dataIndex: 'nodes_down',    tdCls: 'gridTree', flex: 1,stateId: 'StateGridMeshes8'},
            { 
                text    : i18n('sNotes'),
                sortable: false,
                width   : 130,
