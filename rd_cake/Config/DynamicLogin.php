...
$config['DynamicLogin']['theme']['Default'] = array(
	...
	'mikrotik_desktop'	=> '/rd_login_pages/desktop/Mikrotik/build/production/CoovaChilli/index.html',
	'mikrotik_mobile'	=> '/rd_login_pages/mobile/Mikrotik/build/production/CoovaChilli/index.html',
);
...
$config['DynamicLogin']['theme']['Green'] = array(
	...
	'mikrotik_desktop'	=> '/rd_login_pages/desktop/Mikrotik/build/production/CoovaChilli/index_green.html',
	'mikrotik_mobile'	=> '/rd_login_pages/mobile/Mikrotik/build/production/CoovaChilli/index_green.html',
);
...
$config['DynamicLogin']['theme']['Black'] = array(
	...
	'mikrotik_desktop'	=> '/rd_login_pages/desktop/Mikrotik/build/production/CoovaChilli/index_black.html',
	'mikrotik_mobile'	=> '/rd_login_pages/mobile/Mikrotik/build/production/CoovaChilli/index_black.html',
);
...
$config['DynamicLogin']['theme']['Grey'] = array(
	...
	'mikrotik_desktop'	=> '/rd_login_pages/desktop/Mikrotik/build/production/CoovaChilli/index_grey.html',
	'mikrotik_mobile'	=> '/rd_login_pages/mobile/Mikrotik/build/production/CoovaChilli/index_grey.html',
);
