...
'<input type="hidden" name="hosted_button_id" value="GFMJBNPPECVMJ">',
...
'<tr><td class="thead"><input type="hidden" name="on0" value="Vouchers">Vouchers</td></tr><tr><td><select name="os0">',
    '<option value="2Hours">2Hours £0.50 GBP</option>',
	'<option value="8Hours">8Hours £8.00 GBP</option>',
	'<option value="24Hours">24Hours £10.00 GBP</option>',
	'<option value="72Hours">72Hours £15.00 GBP</option>',
