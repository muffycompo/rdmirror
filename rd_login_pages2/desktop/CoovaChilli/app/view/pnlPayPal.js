        ...
        me.items    = [
            ...
            },
            {
               // bodyStyle   :{"background-color":"blue"},
                flex        : 1,
                html        : [
'<div><h3>Need extra time on the Internet?</h3></div>',
...
'<input type="hidden" name="notify_url" value="http://radiusdev.webage.co/cake2/rd_cake/fin_paypal_transactions/paypal_ipn.json" />',
'<table>',
